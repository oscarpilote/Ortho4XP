...
if %py%==27 (
   reg Query "HKLM\SOFTWARE\Python\PythonCore\3.7" | find /i "3.7" > NUL && set py=37 || set py=27
)

if %py%==27 (
   reg Query "HKLM\SOFTWARE\Python\PythonCore\3.6" | find /i "3.6" > NUL && set py=36 || set py=27
)
